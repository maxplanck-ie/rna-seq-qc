...
## Both strands
run "[ -f $outdir/${bname}.bothstrands.bam ] || $samtools view -b -F 256 $infile > $outdir/${bname}.bothstrands.bam"
...
run "[ -f $outdir/${bname}.fwd.bw ] || $deeptools_dir/bamCoverage -b $outdir/${bname}.fwd.bam $opts -o $outdir/${bname}.fwd.bw --scaleFactor $scaleFactor"
...
run "[ -f $outdir/${bname}.rev.bw ] || $deeptools_dir/bamCoverage -b $outdir/${bname}.rev.bam $opts -o $outdir/${bname}.rev.bw --scaleFactor $scaleFactor"
