...
@
FASTQ: number of sequencing reads, TrimGalore: number of reads after trimming, HISAT2/TopHat2: number of mapped reads defined by samtools flags (-f3 -q20) for proper pair + primary alignment, featureCounts/htseq-count: counts of reads mapped to genes, \%: percentage compared to the starting number of sequencing reads
