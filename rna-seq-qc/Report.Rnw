...
\IfFileExists{/data/processing/kilpert/test/rna-seq-qc/Ausma/PE_mm10_FULL_hisat_trim/project_report/plots2.png}{
\section{Sample correlations}
\begin{figure}[ht]
\centering
\includegraphics[width=1\textwidth,]{/data/processing/kilpert/test/rna-seq-qc/Ausma/PE_mm10_FULL_hisat_trim/project_report/plots2.png}
...
\IfFileExists{/data/processing/kilpert/test/rna-seq-qc/Ausma/PE_mm10_FULL_hisat_trim/project_report/plots1.png}{
\section{Differential expression}
\begin{figure}[ht]
\centering
\includegraphics[width=1\textwidth,]{/data/processing/kilpert/test/rna-seq-qc/Ausma/PE_mm10_FULL_hisat_trim/project_report/plots1.png}
